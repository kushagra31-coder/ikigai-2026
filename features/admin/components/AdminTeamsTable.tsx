...
export function AdminTeamsTable({ teams, onBulkAssignTrack, onBulkLock, onBulkUnlock }: { teams: AdminTeam[], onBulkAssignTrack: (ids: string[]) => void, onBulkLock: (ids: string[]) => void, onBulkUnlock: (ids: string[]) => void }) {
