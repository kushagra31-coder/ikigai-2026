...
- Name: rbac.spec.ts >> Role Based Access Control (RBAC) >> Regular Team Member User >> should access team workspace
- Location: e2e\rbac.spec.ts:42:9
      ...
      - generic [ref=e10]:
        - generic [ref=e11]:
          ...
          - link "Forgot password?" [ref=e13] [cursor=pointer]:
            - /url: "#"
        - textbox "Password" [disabled] [ref=e14]: team123
